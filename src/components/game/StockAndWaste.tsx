...
const StockAndWaste: React.FC<StockAndWasteProps> = ({
  ...
  return (
    <div className="flex gap-2">
      <div
        className="w-[2.8rem] h-[3.9rem] md:w-[11rem] md:h-[15.4rem] rounded-sm border border-white/20 cursor-pointer"
        onClick={onDraw}
      >
        {stock.length > 0 && (
          <Card 
      ...
      <div className="w-[2.8rem] h-[3.9rem] md:w-[11rem] md:h-[15.4rem] rounded-sm border border-white/20">
        {waste.length > 0 && (
          <Card 
